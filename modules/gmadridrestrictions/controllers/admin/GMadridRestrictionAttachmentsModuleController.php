...
class GMadridRestrictionAttachmentsModuleController extends ModuleAdminController
{
    public function __construct()
    {
        parent::__construct();
        $this->bootstrap = true; // use Bootstrap CSS
        $this->table = 'gmadridrestrictions_attachment_rule_definition'; // SQL table name, will be prefixed with _DB_PREFIX_
        $this->identifier = 'id_definition'; // SQL column to be used as primary key
        $this->className = 'GMadridRestrictionsAttachmentRuleDefinition'; // PHP class name
        ...
        $this->fields_list = [
            ...
            'id_attachment' => ['title' => 'Attachment ID'],
        ...
        $this->fields_form = [
            'legend' => [
                'title' => $this->trans('Attachment Restrictions', [], 'Modules.gmadridRestrictionsmodule.Admin'),
                'icon' => 'icon-list-ul'
            ],
            'input' => [
                [
                    ...
                    'name' => 'active',
                    'is_bool' => true,
                    'desc' => $this->trans('If active, the attachment is restricted to the specified user group', [], 'Modules.gmadridRestrictionsmodule.Admin'),
                    'values' => [
                        [
                            'id' => 'active_on',
                            'value' => '1',
