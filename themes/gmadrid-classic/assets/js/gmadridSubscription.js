...
var _prestashop = __webpack_require__(30);
...
var GmadridSubscription = function () {
  function GmadridSubscription(membershipProductId, authenticationToken, checkoutUrl) {
    _classCallCheck(this, GmadridSubscription);

    this._membershipProductId = null;
  ...
  _createClass(GmadridSubscription, [{
    key: "deleteProductFromCart",
    value: function () {
      var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(productId, idProductAttribute) {
        var _this = this;
        ...
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                return _context.abrupt("return", new Promise(function (resolutionFunc, rejectionFunc) {
                  var requestData = {
                    ajax: '1',
                    action: 'update'
                  };
                  var cartAction = {
                    url: "/index.php?controller=cart&delete=1&id_product=" + productId + "&id_product_attribute=" + idProductAttribute + "&token=" + _this._authenticationToken,
                  ...
                  _jquery2.default.ajax({
                    ...
                    dataType: 'json',
                    beforeSend: function beforeSend(jqXHR) {}
                  }).success(resolutionFunc).error(rejectionFunc);
                }));
      ...
      function deleteProductFromCart(_x, _x2) {
    ...
    value: function () {
      var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
        var _iteratorNormalCompletion, _didIteratorError, _iteratorError, _iterator, _step, product, productId, idProductAttribute;
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                _context2.prev = 3;
                _iterator = prestashop.cart.products[Symbol.iterator]();
              ...
              case 5:
                ...
                _context2.next = 11;
                return this.deleteProductFromCart(productId, idProductAttribute, this._authenticationToken);
    ...
    value: function () {
        ...
        return regeneratorRuntime.wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                return _context3.abrupt("return", new Promise(function (resolutionFunc, rejectionFunc) {
                  var cartAction = {
                    url: "/index.php?controller=cart&add=1&id_product=" + _this2._membershipProductId + "&token=" + _this2._authenticationToken,
                    type: 'update-cart'
                  };
      ...
      function addMembershipProduct() {
        return _ref3.apply(this, arguments);
      }

      return addMembershipProduct;
    }()
  }, {
    key: "processMembership",
    value: function () {
        ...
        return regeneratorRuntime.wrap(function _callee4$(_context4) {
          while (1) {
            switch (_context4.prev = _context4.next) {
              ...
              case 2:
                _context4.next = 4;
                return this.addMembershipProduct();
  ...
  return GmadridSubscription;
}();

var GMadridSubscriptionButton = function () {
  function GMadridSubscriptionButton(buttonId) {
    _classCallCheck(this, GMadridSubscriptionButton);

    this._element = null;
    this._text = null;

    this._element = (0, _jquery2.default)(buttonId);
  }

  _createClass(GMadridSubscriptionButton, [{
    key: "waiting",
  ...
  return GMadridSubscriptionButton;
}();

GMadridSubscriptionButton._pristine_content = '<i class="material-icons" style="width: 5px !important">card_membership</i> Suscríbete';
GMadridSubscriptionButton._waiting_content = 'Preparando la compra...';
...
(0, _jquery2.default)('#gmadrid-membership').on('click', function (event) {
  ...
  var productId = (0, _jquery2.default)("#gmadrid-membership").data("membership-product-id");
  var checkoutUrl = (0, _jquery2.default)("#gmadrid-membership").data("checkout-url");
  var token = window.prestashop.static_token;
  button.waiting();
  var gmadridSubscription = new GmadridSubscription(productId, token, checkoutUrl);
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(68), __webpack_require__(97)(module)))
